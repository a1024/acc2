...
//	TOKEN(0, CT_VAL_WCHAR_LITERAL, 0)
	...
	TOKEN(0, PT_DECLARATION, 0) TOKEN(0, PT_DECLARATION_PARENS, 0)
	TOKEN(0, PT_DECLARATORS, 0)
	TOKEN(0, PT_TYPE, 0) TOKEN(0, PT_TYPESPEC, 0)
	TOKEN(0, PT_VAR_DECL, 0) TOKEN(0, PT_VAR_DEF, 0) TOKEN(0, PT_VAR_REF, 0)
	TOKEN(0, PT_FUNC_DECL, 0) TOKEN(0, PT_FUNC_DEF, 0) TOKEN(0, PT_FUNC_ARGS, 0) TOKEN(0, PT_ARG_DECL, 0) TOKEN(0, PT_DECL_LIST, 0) TOKEN(0, PT_MEMBER_INIT_LIST, 0) TOKEN(0, PR_MEMBER_INIT, 0)
